...
describe('Database Session Integration', () => {
  ...
  beforeEach(() => {
    ...
    const mockDb = createMockDatabase(mockUsersCollection, mockSessionsCollection);
...
>>>>>>> a7f3863 (refactor: reduce complexity and eliminate code duplication in test files)
    });
